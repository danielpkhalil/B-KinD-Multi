...
from SAMT.src.groundingdino.groundingdino.models import build_model as build_grounding_dino
from SAMT.src.groundingdino.groundingdino.util.slconfig import SLConfig
from SAMT.src.groundingdino.groundingdino.util.utils import clean_state_dict
from SAMT.src.groundingdino.groundingdino.util.inference import annotate, load_image, predict
import SAMT.src.groundingdino.groundingdino.datasets.transforms as T

from torchvision.ops import box_convert

class Detector:
    def __init__(self, device):
        config_file = "SAMT/src/groundingdino/groundingdino/config/GroundingDINO_SwinT_OGC.py"
        grounding_dino_ckpt = './SAMT/ckpt/groundingdino_swint_ogc.pth'
