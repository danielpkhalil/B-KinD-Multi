import sys
sys.path.append("..")
sys.path.append("./SAMT/sam")
from SAMT.sam.segment_anything import sam_model_registry, SamAutomaticMaskGenerator
from SAMT.aot_tracker import get_aot
import numpy as np
from SAMT.tool.segmentor import Segmentor
from SAMT.tool.detector import Detector
from SAMT.tool.transfer_tools import draw_outline, draw_points
import cv2
from SAMT.seg_track_anything import draw_mask
...
if __name__ == '__main__':
    ...
    origin_frame = cv2.imread('/data2/cym/Seg_Tra_any/SAMT/debug/point.png')
