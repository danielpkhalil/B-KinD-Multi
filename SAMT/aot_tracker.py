...
import os
import sys
sys.path.append("./SAMT/aot")
from SAMT.aot.networks.engines.aot_engine import AOTEngine,AOTInferEngine
from SAMT.aot.networks.engines.deaot_engine import DeAOTEngine,DeAOTInferEngine
import importlib
import numpy as np
...
import SAMT.aot.dataloaders.video_transforms as tr
from SAMT.aot.utils.checkpoint import load_network
from SAMT.aot.networks.models import build_vos_model
from SAMT.aot.networks.engines import build_engine
